            ...
            .uk-card-body
                form.uk-form-stacked
                    ...
                    .uk-margin-small
                        ...
                        .uk-form-controls
                            input.uk-checkbox(type="checkbox", v-model="data.safe_spot").uk-margin-small-right
                    ...
                    .uk-margin-small(v-for="(category, index) in categories", :key="index")
                        ...
                        .uk-form-controls
                            .uk-flex
                                ...
                                button.uk-button.uk-button-default.uk-button-small(type="button", @click="removeCategory(index)")
                                    v-icon(name="trash")
                    btnAdd(@click="createCategory")
            .uk-card-footer.uk-text-right
                button.uk-button.uk-button-primary.uk-button-small(@click="save()", :disabled="saving")
                    v-icon(name="save").uk-margin-small-right
                    span {{ strings.admin_btn_save }}
                button.uk-button.uk-button-default.uk-button-small(@click="goToLevelList()", :disabled="saving").uk-margin-small-left
